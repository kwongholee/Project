...
import studyImage from '../img/study.png';
import mentalAttitudeImage from '../img/mentalAttitude.png';
import fullstackImage from '../img/fullstack.png';
...
function Introduce() {
  ...
  return(
    <div>
      ...
      <div style={{marginTop:'400px'}}><h5><strong>1. 이 페이지를 <ins>왜 만들게 됐는지</ins> 설명해드리겠음!</strong></h5></div>

      <div className='box'>
        <div style={{marginTop:'400px', marginLeft:'40px', textAlign: 'left'}} className="left-box">
          <p>일단 시작은 이거임</p>
        ...
        <div>
          <img style={{marginRight: '40px'}} src={studyImage} className="sideImage rightImage"></img>
        </div>
      </div>

      <div>
        <div style={{marginTop:'400px', marginRight:'40px', textAlign: 'right'}}>
        ...
        <div>
          <img style={{marginLeft: '40px'}} src={mentalAttitudeImage} className="sideImage leftImage"></img>
        </div>
      </div>
      
      <div>
        <div style={{marginTop:'400px', marginLeft:'40px', textAlign: 'left'}}>
        ...
        <div>
          <img style={{marginRight: '40px'}} src={fullstackImage} className="sideImage rightImage"></img>
        </div>
      </div>
      ...
      <div style={{marginTop:'400px'}}>
        ...
        <div style={{textAlign: 'left', marginTop:'400px', marginLeft:'40px'}}>
      ...
      <div>
        <img style={{display: 'block'}} src={reactImage} className="sideImage rightImage"></img>
        <img style={{display: 'block'}} src={nodeImage} className="sideImage rightImage"></img>
      </div>
    </div>
  );
}
